...
public class HashFunctionBuiltin {
  ...
  private static SymbolTable buildGlobalSymbolTable() {
    ...
    symbolTable.set("sum", new BuiltinFunction(HashFunctionBuiltin::sum, "(a): Sum of a"));
    symbolTable.set("map", new BuiltinFunction(HashFunctionBuiltin::map, "(a, f): Apply f to each element of a"));
    symbolTable.set("len", new BuiltinFunction(HashFunctionBuiltin::len, "(a): Length of a"));
    symbolTable.set("range", new BuiltinFunction(HashFunctionBuiltin::range, "(end): Array of [0..end]"));
    return symbolTable;
  }
